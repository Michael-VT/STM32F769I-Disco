...
/**
 * @brief  LCD Driver Type enumeration
 */
typedef enum {
  LCD_CTRL_NT35510,    /*!< NT35510 LCD controller */
  LCD_CTRL_OTM8009A,   /*!< OTM8009A LCD controller */
  LCD_CTRL_NONE         /*!< No LCD controller */
} LCD_Driver_t;
...
/* @brief LTDC handle variable */
extern LTDC_HandleTypeDef hltdc_discovery;

/* @brief LCD X and Y sizes */
extern uint32_t lcd_x_size;
extern uint32_t lcd_y_size;

/* @brief LCD driver type detection variable */
